...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <?php else: ?>
                <a href="login.php" class="btn-deposer ms-3">
                    <i class="bi bi-plus-circle"></i>Déposer une annonce
                </a>
            <?php endif; ?>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?= isset($_SESSION['user']) ? 'index.php' : 'login.php' ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= isset($_SESSION['user']) ? 'favoris.php' : 'login.php' ?>">
                        <i class="bi bi-heart"></i>
                        <span>Favoris</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= isset($_SESSION['user']) ? 'messages.php' : 'login.php' ?>">
            ...
            <!-- Bouton "Se connecter" -->
            <?php if (!isset($_SESSION['user'])): ?>
                <a href="login.php" class="btn-login ms-3">Se connecter</a>
            <?php else: ?>
                <a href="logout.php" class="btn-login ms-3">Se déconnecter</a>
            <?php endif; ?>
        </div>
    </nav>
</body>
